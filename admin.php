		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-6">
					<ul class="nav nav-tabs">
						...
						<li id="menu" class="active_page"><a href="admin.php">Admin</a></li>
						<li class="dropdown">
			...
			<div class="row">
				<div class="col-md-10 col-md-offset-1 img-thumbnail">
					<div class="col-md-12">
						<form>
							<center><h2>Ajouter un article</h2></center><br/>
							<div>
								<label for="portfolio_portfoliobundle_article_title" class="required">Title</label>
								<input type="text" id="portfolio_portfoliobundle_article_title" name="portfolio_portfoliobundle_article[title]" required="required" class="form-control" placeholder="Add a comment">
							</div>
							<div>
								<label for="portfolio_portfoliobundle_article_autor" class="required">Autor</label>
								<input type="text" id="portfolio_portfoliobundle_article_autor" name="portfolio_portfoliobundle_article[autor]" required="required" class="form-control" placeholder="Add a comment"
								></div>
							<div>
								<label for="portfolio_portfoliobundle_article_description" class="required">Description</label>
								<textarea required="required" class="form-control" rows="6" placeholder="Add a comment"></textarea>
							</div>
							<div>
								<label for="portfolio_portfoliobundle_article_content" class="required">Content</label>
								<textarea required="required" class="form-control" rows="6" placeholder="Add a comment"></textarea>
							</div>
							<div>
								<label class="required">Image</label>
								<input type="file" required="required" class="form-control" placeholder="Add a comment"><br/>
							</div>
						</form>
					</div>
				</div>
